...
/**
 * This class implements the binary tree using DFS (Depth First Search) algorithm.
 * DFS can be implemented using recursion or Stack.
 * This implementation uses Recursion.
 * Time Complexity - O(n)
 * Space Complexity for Balanced Binary Tree - O(Log n)
 * Space Complexity for Skewed Binary Tree - O(n)
 * @author sainik73
 */
